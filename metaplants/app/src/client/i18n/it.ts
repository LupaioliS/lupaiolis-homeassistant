export const it = {
	...
	actions: {
		...
		confirm: 'Conferma',
		sourceLabel: 'Chi ha dato l\'acqua',
		source_manual: 'A mano',
		source_rain: 'Pioggia',
		source_irrigation: 'Impianto',
		rainAmountUnknown: 'Quantità non registrata: di una pioggia non si sa quanta ne arrivi davvero nel vaso',
		skip: 'Salta',
	...
	prediction: {
		...
		calibrationCycle: '· {date} {source} secco {dry}%, bagnato {wet}%',
	...
	history: {
		...
		back: '← Torna alle piante',
		hint: 'La data di un\'irrigazione è ciò da cui il modello impara la scala del terreno: correggila qui se hai premuto il pulsante in ritardo, o cancella una riga che non deve insegnare niente.',
		...
		colType: 'Tipo',
		colAmount: 'Quantità',
		colSource: 'Provenienza',
		colNotes: 'Note',
		confirmDelete: 'Eliminare questa riga dallo storico?',
